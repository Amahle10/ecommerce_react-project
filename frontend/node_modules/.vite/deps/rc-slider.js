	...
	*/
	(function() {
		...
		function parseValue(arg) {
			...
			if (Array.isArray(arg)) return classNames$2.apply(null, arg);
		...
		if (typeof module !== "undefined" && module.exports) {
			classNames$2.default = classNames$2;
			module.exports = classNames$2;
		} else if (typeof define === "function" && typeof define.amd === "object" && define.amd) define("classnames", [], function() {
			return classNames$2;
		});
		else window.classNames = classNames$2;
	})();
}) });
...
var useLayoutEffect = function useLayoutEffect$1(callback, deps) {
...
var Mark = function Mark$1(props) {
	...
	var _React$useContext = import_react.useContext(context_default), min = _React$useContext.min, max = _React$useContext.max, direction = _React$useContext.direction, includedStart = _React$useContext.includedStart, includedEnd = _React$useContext.includedEnd, included = _React$useContext.included;
...
var Dot = function Dot$1(props) {
	...
	var _React$useContext = import_react.useContext(context_default), min = _React$useContext.min, max = _React$useContext.max, direction = _React$useContext.direction, included = _React$useContext.included, includedStart = _React$useContext.includedStart, includedEnd = _React$useContext.includedEnd;
...
var Steps = function Steps$1(props) {
	var prefixCls = props.prefixCls, marks = props.marks, dots = props.dots, style = props.style, activeStyle = props.activeStyle;
	var _React$useContext = import_react.useContext(context_default), min = _React$useContext.min, max = _React$useContext.max, step = _React$useContext.step;
...
var Track = function Track$1(props) {
	...
	var _React$useContext = import_react.useContext(context_default), direction = _React$useContext.direction, min = _React$useContext.min, max = _React$useContext.max, disabled = _React$useContext.disabled, range = _React$useContext.range, classNames$2 = _React$useContext.classNames;
...
var Tracks = function Tracks$1(props) {
	...
	var _React$useContext = import_react.useContext(context_default), included = _React$useContext.included, range = _React$useContext.range, min = _React$useContext.min, styles = _React$useContext.styles, classNames$2 = _React$useContext.classNames;
	...
	var tracksNode = trackList !== null && trackList !== void 0 && trackList.length && (classNames$2.tracks || styles.tracks) ? /* @__PURE__ */ import_react.createElement(Track_default, {
		index: null,
		prefixCls,
...
//#endregion
export { UnstableContext, es_default as default };
